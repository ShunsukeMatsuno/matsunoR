#' Censor values within the range \deqn{[0,1]}
#'
#' This function ensures that each element in `x` is constrained within the interval \deqn{[0,1]}.
...
#' @return A numeric value or vector with all elements censored within \deqn{[0,1]}.
#' @examples
